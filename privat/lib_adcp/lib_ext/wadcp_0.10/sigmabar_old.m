...
function [sigbar,sigbartot]=sigmabar(choicePart,choiceMod,f,a_s,rho_s,c_s)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
c0=1505;rho0=1025; %(T=15deg,S=34psu)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
k=2*pi/(c0/f/1000);
ka=k.*a_s;
ka2=ka.^2;
...
xitot=2*sqrt(2*B)/R;
sigbartot=4*pi*B*a_s.^2.*(ka4./(1+xitot.*ka2+(2*B/R^2)*ka4));
