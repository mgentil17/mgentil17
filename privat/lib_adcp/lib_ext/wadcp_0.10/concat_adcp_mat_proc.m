...
BIout=[BIout; data.BI.val];
Mglout=[Mglout; data.Mgl.val];
...
fileout_name=strcat(fileout_name(1:end),'_proc.mat');
...
data.BI.obj='Backscatter Index'; data.BI.unit='dB'; data.BI.val=BIout;
data.Mgl.obj='SPM mass concentratio'; data.Mgl.unit='g/l'; data.Mgl.val=Mglout;
