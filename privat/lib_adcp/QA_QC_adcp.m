function [C_fileout, T_fileout] = QA_QC_adcp(r_adcp_concat, glid_l, deploy, plot_out);
...
struct = r_adcp_concat;
survey = strcat(glid_l, '-', deploy);
...
% Current
Cser.BTvel1   = BTvel1_c;
Cser.BTvel2   = BTvel2_c;
Cser.BTvel3   = BTvel3;
Cser.BTvel4   = BTvel4;
Cser.alt = alt;
Cser.sal    = S;
